...
const SearchResults = () => {
  ...
  if (!pokemon || !evolutionChain) {
    return (
      <div className="min-h-screen bg-yellow-200">
        ...
        <h1 className="mx-2 text-lg font-extrabold text-orange-700 sm:xl lg:2xl font-poppins sm:mx-4 lg:mx-6">
  ...
  return (
    <div className="min-h-screen py-4 bg-yellow-200">
      ...
      <div className="mx-2 bg-orange-600 border-2 rounded-md sm:mx-4 lg:mx-6 border-orange-950 bg-opacity-40">
